...
<body>
    ...
    <div class="restart"><a href="player_computer.php"><button class="restartb">RESTART GAME</button></a></div>
    <div class="home"><a href="index.php"><button class="homeg">HOME</button></a></div>
